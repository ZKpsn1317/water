...
class BaseController extends Controller
{
    ...
    protected function _initialize()
    {
        ...
        $this->admin_id = $admin_id = Session::get('admin_id');
        ...
        if(in_array($requestPath, ['index/index','index/main', 'upload/indeximg', 'device/shareqrcode', 'device/outqrcode', 'upload/doupimg', 'upload/getmoreimg'])) {
            return true;
        }
    ...
    {
        $aothCacheName = \app\common\config\Confg::getOathCacheName($userId);
    ...
    /**
     * 把两个数组合并，php自带的函数，把会数字键的，数组键重置比如
     * $arr = [1=>'a', '2'=>'b']  后变成 [0=>'a', '1'=>b]
     * @param $arr
     * @param $arr2
     * @return mixed
     */
