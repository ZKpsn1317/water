...
class WaterRechargeLogController extends BaseController
{
    ...
    public function index ()
    {
        ...
        if ( input( 'export' ) ) {
            ...
            $list = WaterRechargeLog::where( $where )->field('dlc_water_recharge_log.*,dlc_water_recharge.username,dlc_water_recharge.mobile,dlc_water_recharge.name,dlc_water_recharge.agent_id')->join( 'water_recharge', 'dlc_water_recharge.water_recharge_id = dlc_water_recharge_log.water_recharge_id', 'left' )->page( $page, $psize )->order('dlc_water_recharge_log.water_recharge_id desc')->select();
        }
