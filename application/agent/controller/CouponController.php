...
class CouponController extends BaseController
{
    ...
    {
        $this->assign('status', Coupon::$status);
        $this->assign('type', Coupon::$types);
    }
    ...
    public function index()
    {
        ...
        $page = input('page')?input('page'):1;
         if(input('export')) {
            ...
            $list = Coupon::where($where)->page($page,$psize)->select();  //order('Coupon_id DESC')->
         }
    ...
    public function del()
    {
        ...
        $model = Coupon::get(['Coupon_id' => $id, 'agent_id' => $this->agent_id]);
