...
class RepairmanController extends BaseController
{
    ...
    {
        return [
            'username'  => ['name' => '用户名', 'value' => '', 'type' => 'text', 'searchType' => '='],
        ];
    }
    ...
    public function index()
    {
        ...
        $page = input('page')?input('page'):1;
         if(input('export')) {
            $list = AdminAgent::where($where)->select();
            Excel::export($list, $this->exportField);
         } else {
            $list = AdminAgent::where($where)->page($page,$psize)->select();
         }
        
        
        $count = AdminAgent::where($where)->count();
    ...
    public function add()
    {
        ...
        $this->assignOption();
        echo $this->fetch('repairman_form');
    }
    ...
    public function edit()
    {
        ...
        $model = AdminAgent::get(['id' => $id, 'agent_id' => $this->agent_id]);
    ...
    public function del()
    {
        ...
        $model = AdminAgent::get(['water_recharge_id' => $id, 'agent_id' => $this->agent_id]);
